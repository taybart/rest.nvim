...
function M.setup()
  ...
  vim.api.nvim_create_autocmd('BufRead,BufNewFile', {
    ...
    callback = function()
      ...
      vim.api.nvim_create_user_command('ExecuteFile', M.exec_block_under_cursor, {})

      vim.keymap.set('n', '<c-e>', M.exec_block_under_cursor, {})
      vim.keymap.set('n', '<c-t>', M.execute_file, {})
    end,
  })
end
